...
[![Tests](https://github.com/blue-bit-shift/cmp_tool/actions/workflows/test.yml/badge.svg?branch=master)](https://github.com/blue-bit-shift/cmp_tool/actions/workflows/test.yml)
